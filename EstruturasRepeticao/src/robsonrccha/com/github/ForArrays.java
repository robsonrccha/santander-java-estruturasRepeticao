...
public class ForArrays {
	...
	public static void main(String[] args) {
		...
		// Também usamos o controle de fluxo for, para interagir sobre arrays e
		// coleções:
		...
		for (String aluno : alunos) { // String aluno : alunos -> De forma abreviada, é criada uma variável nome
